package com.example.manol_000.apples1;
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                 ...
                 */
                    ...
                    float y = event.getY();
                    int x_coord,y_coord;
                    x_coord=(int)(x/mTileSize);
                    y_coord = (int)(y/mTileSize);
//                    System.out.println("this is the x_coord " +x_coord);
//                    System.out.println("This is the y_coord "+ y_coord);
                    if(hit(x_coord,y_coord)) {
    ...
    private boolean hit(int x,int y) {
        for(int i=0;i<mAppleList.size();i++)
        {
            ...
            int xComp=mAppleList.get(i).getX();
            int yComp=mAppleList.get(i).getY();
           // System.out.println("this is the apple loc "+ xComp +" "+ yComp);
            if((Math.abs(x-xComp)<=6 ) && (Math.abs(y-yComp)<=6))
            {
                return true;
            }
        }
    ...
    public void update() {
        ...
        //System.out.println("this is the speed "+ mMoveDelay);
        if (mMode == RUNNING) {
